...
CI_EXEC_ROOT rsync --archive --stats --human-readable /ci_base_install/ "${BASE_ROOT_DIR}" || echo "/ci_base_install/ missing"
# Skip 01_base_install.sh as it doesn't exist in Dash
CI_EXEC_ROOT rsync --archive --stats --human-readable /ro_base/ "${BASE_ROOT_DIR}" || echo "Nothing to copy from ro_base"
