...
export BITCOIN_CONFIG="--enable-zmq --with-libs=no --enable-reduce-exports --disable-fuzz-binary LDFLAGS=-static-libstdc++ CPPFLAGS='-DBOOST_MULTI_INDEX_ENABLE_SAFE_MODE' --with-boost-process"
