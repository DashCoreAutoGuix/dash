...
requires `bash`, `docker`, and `python3` to be installed. To run on architectures different from the host, `qemu` is also required. To install all requirements on Ubuntu, run
