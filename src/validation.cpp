                                                  ...
                                                  const std::unique_ptr<CChainstateHelper>& chain_helper)
{
    ...
    this->ActivateExistingSnapshot(mempool, evoDb, chain_helper, *base_blockhash);
    return true;
}

CChainState& ChainstateManager::ActivateExistingSnapshot(CTxMemPool* mempool,
                                                          CEvoDB& evoDb,
                                                          const std::unique_ptr<CChainstateHelper>& chain_helper,
                                                          uint256 base_blockhash)
{
    ...
    m_snapshot_chainstate =
        std::make_unique<CChainState>(mempool, m_blockman, *this, evoDb, chain_helper, base_blockhash);
