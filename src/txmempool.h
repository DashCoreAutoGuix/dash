...
public:
    ...
    mutable size_t idx_randomized; //!< Index in mempool's vTxHashes
...
public:
    ...
    std::vector<CTransactionRef> txns_randomized GUARDED_BY(cs); //!< All tx hashes/entries in mapTx, in random order
