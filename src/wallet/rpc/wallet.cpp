    ...
    return RPCHelpMan{"loadwallet",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::STR, "warning", /*optional=*/true, "Warning message if wallet was not loaded cleanly. (DEPRECATED, returned only if config option -deprecatedrpc=walletwarningfield is passed.)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (gArgs.GetBoolArg("-deprecatedrpc", false)) {
...
static RPCHelpMan unloadwallet()
{
    return RPCHelpMan{"unloadwallet",
        ...
        RPCResult{RPCResult::Type::OBJ, "", "", {
            {RPCResult::Type::STR, "warning", /*optional=*/true, "Warning message if wallet was not unloaded cleanly. (DEPRECATED, returned only if config option -deprecatedrpc=walletwarningfield is passed.)"},
