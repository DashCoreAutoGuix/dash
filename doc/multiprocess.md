...
[#19460](https://github.com/dash/dash/pull/19460) also adds a new `dash-node` `-ipcbind` option and an `dash-wallet` `-ipcconnect` option to allow new wallet processes to connect to an existing node process.
