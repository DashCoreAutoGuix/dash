...
from test_framework.messages import (
    BIP125_SEQUENCE_NUMBER as MAX_BIP125_RBF_SEQUENCE,
)
from test_framework.test_framework import BitcoinTestFramework as DashTestFramework
...
class BumpFeeTest(DashTestFramework):
