...
class SendallTest(BitcoinTestFramework):
    ...
    def sendall_negative_effective_value(self):
        ...
        # Use amounts above dust threshold (546 sat) but still uneconomical at high fee rates
    ...
    def sendall_with_send_max(self):
        ...
        # Use amounts above dust threshold (546 sat) but still uneconomical at high fee rates
        self.add_utxos([0.00000600, 0.00000600, 1])
        ...
        assert_equal(self.wallet.getbalances()["mine"]["trusted"], Decimal("0.00001200"))
