...
from test_framework.util import (
    MAX_NODES,
    p2p_port,
    wait_until_helper_internal_internal,
)
...
class P2PInterface(P2PConnection):
    ...
    def wait_until(self, test_function_in, *, timeout=60, check_connected=True):
        ...
        wait_until_helper_internal_internal(test_function, timeout=timeout, lock=p2p_lock, timeout_factor=self.timeout_factor)
...
class NetworkThread(threading.Thread):
    ...
    def close(self, timeout=10):
        ...
        wait_until_helper_internal_internal(lambda: not self.network_event_loop.is_running(), timeout=timeout)
