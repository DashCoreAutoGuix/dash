...
signature file SHA256SUMS.asc from github.com and dashcore-binaries.thepasta.org
and compares them.
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    # remove binaries that are known not to be hosted by dashcore.org
...
def main():
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes dashcore-binaries.thepasta.org lags behind github.com.)')
    )
