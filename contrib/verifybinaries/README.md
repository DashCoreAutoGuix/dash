...
As of Dash Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/dashpay/guix.sigs/). When
...
builder-keys](https://github.com/dashpay/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://github.com/dashpay/dash and https://dashcore-binaries.thepasta.org.
...
./contrib/verifybinaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/dash-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/dash-24.0.1-arm-linux-gnueabihf.tar.gz
```
